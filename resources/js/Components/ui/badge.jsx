  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        emerald: 'text-white bg-gradient-to-r from-[#26e705]/70 via-[#22ce05]/60 to-[#1fb804]/50 border-[#2a9f03]/60 backdrop-blur-md shadow-[0_0_35px_rgba(38,231,5,0.6),0_0_12px_rgba(42,159,3,0.3)] [&>svg]:text-[#26e705]',
        ...
        funchsia: 'text-white bg-gradient-to-r from-[#189604]/70 via-[#158204]/60 to-[#126e03]/50 border-[#166003]/60 backdrop-blur-md shadow-[0_0_35px_rgba(24,150,3,0.6),0_0_12px_rgba(22,96,3,0.3)] [&>svg]:text-[#189604]',
