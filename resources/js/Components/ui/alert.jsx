    ...
    'relative w-full rounded-lg border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
    {
        variants: {
            variant: {
                ...
                success:
                    'text-white bg-gradient-to-r from-[#7DDA71]/20 via-[#7DDA71]/15 to-[#7DDA71]/10 border border-[#7DDA71]/25 backdrop-blur-md shadow-[0_8px_30px_rgba(2,6,23,0.6),0_0_12px_rgba(125,218,113,0.15)] [&>svg]:text-[#7DDA71]',
